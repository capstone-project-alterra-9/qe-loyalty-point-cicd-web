...
WebUI.click(findTestObject('Object Repository/Log_Out/Page_Loyalty Point App/logout_button'))

WebUI.click(findTestObject('Object Repository/Log_Out/Page_Loyalty Point App/button_Yes'))
