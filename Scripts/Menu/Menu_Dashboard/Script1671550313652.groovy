...
WebUI.click(findTestObject('Object Repository/Menu/Menu_Dashboard/Page_Loyalty Point App/dashboard_button'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu/Menu_Dashboard/Page_Loyalty Point App/verify_dashboard'), 
