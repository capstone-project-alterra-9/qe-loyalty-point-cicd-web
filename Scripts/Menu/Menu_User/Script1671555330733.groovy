...
WebUI.click(findTestObject('Object Repository/Menu/Menu_User/Page_Loyalty Point App/user_button'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu/Menu_User/Page_Loyalty Point App/verify_user'), 'Users Account')
