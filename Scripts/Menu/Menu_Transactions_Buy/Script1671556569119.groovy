...
WebUI.click(findTestObject('Object Repository/Menu/Menu_Transactions_Buy/Page_Loyalty Point App/transactions_button'))

WebUI.click(findTestObject('Object Repository/Menu/Menu_Transactions_Buy/Page_Loyalty Point App/buy_button'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu/Menu_Transactions_Buy/Page_Loyalty Point App/verify_buy'), 'Buy Transactions')
