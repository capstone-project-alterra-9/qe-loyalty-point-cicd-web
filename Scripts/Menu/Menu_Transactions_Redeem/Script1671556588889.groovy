...
WebUI.click(findTestObject('Object Repository/Menu/Menu_Transactions_Redeem/Page_Loyalty Point App/transactions_button'))

WebUI.click(findTestObject('Object Repository/Menu/Menu_Transactions_Redeem/Page_Loyalty Point App/redeem_button'))

WebUI.verifyElementText(findTestObject('Object Repository/Menu/Menu_Transactions_Redeem/Page_Loyalty Point App/verify_redeem'), 
    'Redeem Transactions')
