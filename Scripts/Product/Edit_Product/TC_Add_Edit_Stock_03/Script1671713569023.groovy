...
WebUI.click(findTestObject('Object Repository/Product_Edit_Stock/Page_Loyalty Point App/edit_button'))

WebUI.verifyElementText(findTestObject('Object Repository/Product_Edit_Stock/Page_Loyalty Point App/verify_edit'), 'Edit Product')
